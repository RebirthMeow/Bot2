...
The remainder of this README is the upstream OpenJK content, preserved for
attribution and for users who want the full picture of the engine the fork
is built on.
